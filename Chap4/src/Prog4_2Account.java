...
public class Prog4_2Account 
{
	...
	public Prog4_2Account(String owner, int account, double initial)
	{
		constructor(owner,account,initial);
	}
	
	//Constructor with initial amount at 0
	public Prog4_2Account(String owner, int account)
	{
		constructor(owner,account,0.0);
	}
